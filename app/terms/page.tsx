...
export default function TermsPage() {
  return (
    <main className="legal-page">
      ...
      <p>Базовая цена каталога указана в USD. При оплате booking fee в RUB сумма фиксируется в предложении на 24 часа и округляется до ближайших 100 ₽. Округлённая сумма RUB является окончательной суммой booking fee; остаток сохраняется как 80% базовой цены USD и не пересчитывается из-за округления.</p>
      ...
      <p>USD is the base catalogue price. When the booking fee is paid in RUB, its value is fixed in a 24-hour quote and rounded to the nearest ₽100. The rounded RUB figure is the final booking-fee amount; the balance remains 80% of the USD base price and is not recalculated because of that rounding.</p>
