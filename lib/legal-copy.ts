...
export const privacyCopy = {
  ru: {
    ...
    sections: [
      ...
      { title: "3. Для чего используются данные", paragraphs: ["Данные используются для ответа на запрос, подтверждения выбранного плана и стоимости, оформления бронирования, координации с операционным партнёром на Бали и поддержки во время поездки."] },
      { title: "4. Передача данных", paragraphs: ["После подтверждения оплаты и предварительного уведомления гостя мы передаём операционному партнёру на Бали только данные, необходимые для выполнения бронирования: имя, контакт, даты, количество гостей, место встречи, выбранные услуги и соответствующие особые пожелания. Мы не продаём персональные данные и не используем их для чужой рекламы."] },
  ...
  en: {
    ...
    sections: [
      ...
      { title: "3. How we use it", paragraphs: ["We use the information to answer your enquiry, confirm the selected plan and total, complete the booking, coordinate with the Bali operations partner, and support your trip."] },
      { title: "4. When information is shared", paragraphs: ["After payment is confirmed and you have been notified, we share only the booking information needed by our Bali operations partner: your name, contact details, dates, guest count, pickup location, confirmed services, and relevant special requests. We do not sell personal data or use it for third-party advertising."] },
